...
### 3.2. Module Quản trị Rủi ro (Multi-tier Risk Assessment)
Hệ thống triển khai 3 nhóm tiêu chí rủi ro theo **Quyết định 78/QĐ-TCT**:
1. **Nhóm I - Rủi ro Định tính**: Kiểm tra MST trong danh sách doanh nghiệp bỏ trốn, ngừng hoạt động.
2. **Nhóm II - Rủi ro Định lượng (AI Scoring)**: Đối soát dữ liệu so với vốn điều lệ, tần suất xuất hóa đơn bất thường.
3. **Nhóm III - Rủi ro Tham chiếu**: Cảnh báo dựa trên lịch sử nộp thuế và phản hồi từ ngân hàng/hải quan.
